...
struct CalculatorBrain {
    ...
    private var operations: Dictionary<String, Operation> = [
        ...
        "cos" : Operation.unaryOperation(function: cos, description: {"cos(" + $0 + ")"}, validator: nil, errorText: nil),
        "sin" : Operation.unaryOperation(function: sin, description: {"sin(" + $0 + ")"}, validator: nil, errorText: nil),
        "±" : Operation.unaryOperation(function: {-$0}, description: {"±(" + $0 + ")"}, validator: nil, errorText: nil),
        "㏑" : Operation.unaryOperation(function: log, description: {"ln(" + $0 + ")"}, validator: {$0 > 0.0}, errorText: "Fail to get logarithm of nonpositive number"),
